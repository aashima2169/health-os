  ...
  return (
    <div className="min-h-screen bg-bg pb-28">
      <div className="px-5 pt-10 pb-6">
        ...
        <h1 className="text-3xl font-bold text-ink">Customise</h1>
      ...
      <div className="px-4 space-y-6">
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-widest text-ink-faint px-1 mb-2">
      ...
      <button type="button" className="w-full flex items-center justify-between px-5 py-4"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            <p className="text-xs text-ink-faint">{values.length} items</p>
          </div>
        </div>
      ...
      {open && (
        <div className="px-5 pb-5 border-t border-line pt-4 space-y-3">
          <div className="flex flex-wrap gap-2">
            {values.map((val) => (
              <div key={val} className="flex items-center gap-1.5 bg-surface-alt border
